        ...
        >
            <div class="header-page">
                ...
                <div class="header-menu" :class="{ 'header-menu-open': isMenuShow }">
                    ...
                    <a href="https://gitee.com/weydo/tduck-platform" target="_blank">开源项目</a>
        ...
        <el-main :style="style.content">
            ...
            <div id="content-page" class="content-page">
                <div class="content-explain">
                    ...
                    <h1 data-aos="fade-up" data-aos-duration="1100">Have what you want, get you income.</h1>
            ...
            <div class="footer-page">
                <el-row :gutter="20" class="footer-content">
                    ...
                    <el-col :xs="24" :md="4" :offset="1" class="project-url" data-aos="fade-up" data-aos-delay="200">
                        <h1>项目地址</h1>
                        <a href="https://gitee.com/weydo/tduck-platform" target="_blank">Gitee码云</a>
                    </el-col>
                    <el-col :xs="24" :md="5" data-aos="fade-up" data-aos-delay="300">
                        <h1>联系方式</h1>
                        <span>131****@163.com</span>
                        <span>+86 13112345678</span>
                        <span> 加入团队 131****@163.com</span>
                    </el-col>
                ...
                <div class="footer-copyright" data-aos="fade-down" data-aos-anchor-placement="top-bottom">
                    <p>本站由 ** 提供云服务器</p>
                    <p>本站由 *** 提供CDN加速/云储存服务</p>
                    <p>Copyright © 2021 咕噜咕噜. All Rights Reserved. 版权所有</p>
                </div>
            </div>
        </el-footer>
    </el-container>
...
export default {
    ...
    methods: {
        ...
        onStart() {
            ...
            window.open('https://gitee.com/weydo/tduck-platform', '_blank')
        },
        msgCard() {
