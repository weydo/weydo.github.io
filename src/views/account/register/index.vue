        ...
        <el-tabs v-model="regType" class="register-form">
            <el-tab-pane label="手机号注册" name="regPhone">
                <el-form ref="phoneRegForm" :model="accountForm" :rules="phoneRegRules" label-width="0px">
                    ...
                    <el-button class="width-full" type="success" @click="$router.push({ path: '/login' })">返回登录</el-button>
                </el-form>
            </el-tab-pane>
            <el-tab-pane label="邮箱注册" name="regEmail">
                ...
                >
                    ...
                    <el-form-item>
                        <el-button class="width-full" type="info" @click="$router.push({ path: '/login' })">返回登录</el-button>
                    </el-form-item>
                </el-form>
